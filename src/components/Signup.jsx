...
const Signup = () => {
  ...
  <div className="container px-8 py-24 mx-auto flex flex-wrap items-center">
    <div className="lg:w-3/5 md:w-1/2  md:pr-16 lg:pr-0 pr-0">
      <h1 className="title-font font-medium text-3xl text-white capitalize">Let's Sign You Up</h1>
    ...
    <div className="lg:w-2/6 md:w-1/2 rounded-lg py-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
      ...
      <div className="relative mb-4">
        {/* <label for="full-name" className="leading-7 text-sm text-gray-400">Email</label> */}
